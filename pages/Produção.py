...
while i <= len(data_dist):
    ...
    pecas = pecas[['DTPROGRAMACAO', 'OFERECIMENTO', 'ID_CARGA', 'PROGRAMACAO', 'SEPARADO','% SEP','CONFERIDO','% CONF']]
    pecas.columns = ['DT_PROG', 'OFEREC',  'CARGAS','PEÇAS_PROG', 'SEPARADO', '% SEP', 'CONFERIDO','% CONF']
